...
<div class="navbar has-shadow">
	<div class="container">
		<div class="navbar-brand">
			...
			<a href="/projects/website/environment.php" class="navbar-item is-tab <?php if(isset($projects_website_environment)){echo $projects_website_environment;}?>">Environment</a>
			<a href="/projects/website/navigation.php" class="navbar-item is-tab <?php if(isset($projects_website_navigation)){echo $projects_website_navigation;}?>">Navigation</a>
		</div>
	</div>
</div>
