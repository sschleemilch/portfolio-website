...
<section class="hero is-primary is-medium">
    <div class="hero-body">
        <div class="container has-text-centered">
            <h1 class="title"><span class="icon is-huge"><i class="fa fa-balance-scale"></i></span></h1>
            <h1 class="title"><strong>Impressum</strong></h1>
        </div>
    </div>
</section>
...
<p>Sebastian Schleemilch<br>
Albertus-Magnus-Street 52<br>
71229 Leonberg<br>
Germany</p>
<p>Telephone: +4917655553629<br>
Email: basti.schleemilch@onlinehome.de</p>
