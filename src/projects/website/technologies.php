	...
	<div class="container is-fullhd">
		...
		<div class="content">
			...
			<p>
				...
				So, to finish this topic, <strong>my decision for CSS is</strong>:
			</p>
			<div class="box">
				<div class="columns has-text-centered">
					<div class="column ">
						<a href="http://bulma.io/">
							<img src="/img/icon_is_large_bulma.png" alt="Icon::Bulma" width="92" height="42">
		...
		<div class="content">
			...
			and <strong><a href="https://jquery.com/">jQuery</a></strong> which will make your daily JavaScript life easier.
			<br><br>
			<strong>My JavaScript framework/library Choice:</strong>
			</p>
			<div class="box">
				<div class="columns has-text-centered">
					<div class="column ">
					...
					<div class="column">
						<a href="http://sass-lang.com/">
							<img src="/img/icon_is_large_jquery.png" alt="Icon::jQuery" width="165" height="42">
							<p class="title is-4"> <strong> JavaScript library </strong> </p>
							<p class="subtitle">More powerful and comfortable than vanilla JS</p>
						</a>
					</div>
				</div>
			</div>
